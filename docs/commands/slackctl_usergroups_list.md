## slackctl usergroups list

List user groups

```
slackctl usergroups list [flags]
```
...
```
  -h, --help               help for list
      --include-count      include member counts
      --include-disabled   include disabled groups
      --include-users      include each group's user list
```
