## slackctl canvases create

Create a canvas

```
slackctl canvases create [flags]
```
...
```
      --channel string   create a channel canvas in this conversation
      --content string   document content JSON, e.g. {"type":"markdown","markdown":"…"}
