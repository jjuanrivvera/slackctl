...
Assistant APIs (bot-token search)
...
* [slackctl assistant search-context](slackctl_assistant_search-context.md)	 - Search messages and files (works with a bot token)
