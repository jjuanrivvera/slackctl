## slackctl msg ephemeral

Post an ephemeral message (visible to one user)

```
slackctl msg ephemeral [flags]
```

### Examples

```
  slackctl msg ephemeral --channel C0123456 --user U111 --text "only you can see this"
```
...
```
  ...
  -h, --help               help for ephemeral
      ...
      --thread-ts string   show inside this thread
      --user string        user id who sees the message
```
